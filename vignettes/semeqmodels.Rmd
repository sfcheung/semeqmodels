...
fit
#> lavaan 0.7-1.3022 ended normally after 40 iterations
#> 
#>   Estimator                                         ML
...
- If fitted to this dataset, they have
  *nearly* the same fit measures,
  "nearly" defined by a tolerance.
  By default, model $\chi^2$ is used.
...
some time to run because the number of
...
package. Basic knowledge of `semPaths()`
is required.
...
- The value is the maximum absolute difference
  ...
  considered empirical equivalent.
...
the number of models is larger than using
model $\chi^2$.
...
the search for models empirically equivalent
to an original models, and to customize
the plots. Please refer to the help pages
of the functions introduced above for
other arguments.
