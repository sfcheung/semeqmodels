...
`data_test_3obvs` (installed with the package):
...
This model is a saturated model, with model *df* equals zero. Therefore,
all empirically equivalent models will also be saturated because they
will also have zero *df*.
